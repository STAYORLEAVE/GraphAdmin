...
const scale = [{
  ...
  nice: false,
  formatter: item => {
    if((item * 100) % 10 === 0) return item * 100
  }
}];
...
export default {
  ...
  data() {
    return {
      ...
      arcGuide2End: [this.result, 0.945],
      arcGuide2Style: {
        stroke: '#1890FF',
        lineWidth: 18,
      },
      ...
      htmlGuideHtml: `
        <div style="width: 300px;text-align: center;">
          <p style="font-size: 20px;color: #545454;margin: 0;">准确率</p>
          <p style="font-size: 36px;color: #545454;margin: 0;">${this.result * 100}%</p>
        </div>
      `,
    };
  },
